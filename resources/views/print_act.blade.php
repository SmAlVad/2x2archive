...
<head>
  ...
  <title>Печать акта о выполненных работах</title>
  <style>
    body {
      ...
      <table border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td style="width:320px;" valign="top">
            ...
            <p>Расчетный счет: 40702810809560001367 филиал № 2754 Банка ВТБ (ПАО)</p>
            <p>БИК/код МФО: 040813713</p>
            <p>ИНН/КПП: 2801088466 / 280101001</p>
            <p>Телефон: (4162) 20-19-21</p>
          </td>
          <td style="width:47px;">
            <p>&nbsp;</p>
          </td>
